...
I have [provided a modified version of this example with additional explanatory text and modifications](speechRecognition.mlx) to let it run correctly on Rosie. Be sure you are running the modified version.
