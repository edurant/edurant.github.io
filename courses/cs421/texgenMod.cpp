...
/* Modified 27 January 2003 by Dr. E. Durant <durant@msoe.edu>
 * Added r, m, b, d (replace, modulate, blend, decal) mode keys
 * Added {, } to disable/enable texturing (inefficient method)
 */
...
void init(void)
{
   ...
   currentEnvMode = GL_MODULATE;
   glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, currentEnvMode);
